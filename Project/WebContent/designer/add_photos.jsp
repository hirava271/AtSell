...
<form action="<%=request.getContextPath() %>/DPhotoGallary" method="post" enctype="multipart/form-data">

<h3>Multiple File Uploading  Form</h3>
				<hr>
				
				<div id="outer_div" class="form-group">
    				<div id="divfiles0" class="col-sm-10"><input type="file" name="files[0]" id="file0" value="" /></div>
