...
<tbody>
<c:forEach var="i" items="${sessionScope.complaint}" varStatus="ii">
<tr>
<td>${ii.count }</td>
<td>${i.buyer_user_id.first_name} &nbsp;${i.buyer_user_id.last_name}</td>
<td>${i.complaint}</td>
<td><a style="color:blue" href="<%=request.getContextPath() %>/admin/reply.jsp?id=${i.buyer_user_id.loginVoObj.login_id}&comp_id=${i.complaint_id}"><u>Reply</u></a></td>
</tr>
</c:forEach>
</tbody>
</table>
