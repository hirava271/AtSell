...
<c:forEach items="${sessionScope.edit_country_session }" var="i">
<form class="form-horizontal" role="form" method="post" action="<%=request.getContextPath()%>/CountryServlet?flag=save&id=${i.country_id}">
<div class="form-group">
<label class="col-sm-2 control-label">Country Name:</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="add_country_name" value="${i.country_name}">
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" rows="3" name="add_country_description">${i.country_description}</textarea>
</div>
</div>
