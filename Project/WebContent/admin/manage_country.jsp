...
<form class="form-horizontal" role="form" method="post" action="<%=request.getContextPath()%>/CountryServlet?flag=insert">
<div class="form-group">
<label class="col-sm-2 control-label">Country Name:</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="add_country_name">
</div>
</div>
...
<div class="col-sm-10">
<textarea class="form-control" rows="3" name="add_country_description"></textarea>
</div>
</div>
