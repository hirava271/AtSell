...
<link rel="stylesheet" href="<%=request.getContextPath() %>/admin/<%=request.getContextPath() %>/admin/css/chosen.min.css">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/CategoryServlet">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Item type</label>
									<div class="col-sm-10">
										<div class="radio">
											<label>
											<input type="radio" name="type" value="Cloths" id="cloth">Cloths</label>
										</div>
										<div class="radio">
											<label>
											<input type="radio" name="type" value="Accessories" id="accessories">Accessories</label>
										</div>
									</div>
							</div>
							...
							<div class="form-group">
								...
								<input type="hidden" name="flag" value="add_category"> 
							<div class="form-group">
								<label class="col-sm-2 control-label">Category
									Description</label>
								<div class="col-sm-10">
									<textarea class="form-control" rows="3" name="add_category_description"></textarea>
								</div>
							</div>
