...
<c:forEach items="${sessionScope.search_country}" var="i" varStatus="ii">
<tbody>
<tr> 
	<td>
		${ii.count}
	...
	<td><a href="<%=request.getContextPath()%>/CountryServlet?flag=delete&id=${i.country_id}">Delete</a>/
	    <a href="<%=request.getContextPath()%>/CountryServlet?flag=edit&id=${i.country_id}">Edit</a></td>
</tr>
</tbody>
</c:forEach>
</thead>
