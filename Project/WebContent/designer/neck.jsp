...
<form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/DNeckServlet?flag=insert" method="post">
<div class="form-group">
<label class="col-sm-2 control-label">Neck Type:</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="neck_type">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Neck Description:</label>
<div class="col-sm-10">
<textarea class="form-control" rows="3" name="neck_description"></textarea>
</div>
</div>
