...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/designer/css/fonts/font.css">
<link rel="stylesheet"
				...
				<div
					...
					<section class="panel bg-white no-b">
						<ul class="switcher-dash-action">
							...
							<li><a href="<%=request.getContextPath() %>/designer/registration.jsp" class="">New account</a></li>
						</ul>
						<div class="p15">
							<form role="form" action="abc">
								...
								<div class="show">
									<div class="pull-right">
										<a href="forget_pwd.jsp">Forgot password?</a>
									</div>
					...
					<p class="text-center">
						Copyright &copy; <span id="year" class="mr5"></span> <span>Sublime
							LLC</span>
					</p>
				</div>
			</div>
