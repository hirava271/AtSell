...
<c:forEach items="${sessionScope.search_category}" var="i" varStatus="ii">
<tbody>
<tr> 
	<td>
		${ii.count}
	...
	<td><a href="<%=request.getContextPath()%>/CategoryServlet?flag=delete&id=${i.category_id}">Delete</a>/
	    <a href="<%=request.getContextPath()%>/CategoryServlet?flag=edit&id=${i.category_id}">Edit</a></td>
</tr>
</tbody>
</c:forEach>
