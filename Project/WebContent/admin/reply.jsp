		...
		<div class="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<%
							int buyer_user_id=Integer.parseInt(request.getParameter("id"));
							int comp_id=Integer.parseInt(request.getParameter("comp_id")); 
							%>
						<form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/sv_mail">
							
							<input type="hidden" name="buyer_user_id" value="<%=buyer_user_id %>">
							<input type="hidden" name=comp_id value="<%=comp_id %>">
									<input type="hidden" name="flag" value="reply">
							<div class="form-group">
								<label class="col-sm-2 control-label">Reply:
									</label>
								<div class="col-sm-10">
