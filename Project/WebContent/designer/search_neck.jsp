...
<th>ID</th>
<th>Neck Type</th>
<th>Neck Description</th>
<th>Action</th>
</tr>
<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>

<c:forEach items="${sessionScope.search_neck}" var="i" varStatus="j">
<tbody>
<tr> 
	<td>
		${j.count}
	...
	<td><a href="<%=request.getContextPath()%>/DNeckServlet?flag=delete&id=${i.neck_id}">Delete</a>
</tr>
</tbody>
</c:forEach>
