...
<head>
		...
		<link rel="icon" type="image/vnd.microsoft.icon" href="img/favicon.ico?1410257037" />
...
<body id="authentication" class="keep-header authentication hide-left-column hide-right-column lang_en layout-fullwidth" itemscope="" itemtype="http://schema.org/WebPage" >
...
<div class=" breadcrumb">
	<div class="container">
		<a class="home" href="http://pavodemo.com/prestabrain/bella/cyan/" title="Return to Home"><i class="icon-home"></i> Home</a>
...
<!-- /Breadcrumb -->
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12">
			...
			<form class="std box form-horizontal" id="account-creation_form" method="post" action="<%=request.getContextPath() %>/URegistrationServlet?flag=insert">
		...
		<div class="account_creation">
			...
			<div class="clearfix form-group">
				...
				<div class="col-sm-6">
							...
							<label class="top" for="id_gender1">
								<span><input type="radio" value="1" id="id_gender1" name="id_gender"></span>
							Mr.
							</label>
						</div>
											<div class="radio-inline"> 
							<label class="top" for="id_gender2">
								<span><input type="radio" value="2" id="id_gender2" name="id_gender"></span>
							Ms.
							</label>
						</div>
									</div>
			...
			<div class="required form-group">
				<label for="customer_firstname" class="control-label col-sm-4">First name <sup>*</sup></label>
				<div class="col-sm-6 form-error">
					<input type="text" value="" name="fname" id="customer_firstname" data-validate="isName" class="is_required validate form-control" onkeyup="$('#firstname').val(this.value);">
				</div>
			</div>
			<div class="required form-group">
				<label for="customer_lastname" class="control-label col-sm-4">Last name <sup>*</sup></label>
				<div class="col-sm-6 form-error">
					<input type="text" value="" name="lname" id="customer_lastname" data-validate="isName" class="is_required validate form-control" onkeyup="$('#lastname').val(this.value);">
				</div>
			</div>
			<div class="required form-group">
				<label for="email" class="control-label col-sm-4">Email <sup>*</sup></label>
				<div class="col-sm-6">
					<input type="text" value="" name="user_email" id="email" data-validate="isEmail" class="is_required validate form-control">
				</div>
			</div>
			<div class="required password form-group">
				<label for="passwd" class="control-label col-sm-4">Password <sup>*</sup></label>
				<div class="col-sm-6">
					<input type="password" id="passwd" name="upasswd" data-validate="isPasswd" class="is_required validate form-control">
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-8">
					<div class="checkbox">
						<div class="checker" id="uniform-optin"><span><input type="checkbox" value="1" id="optin" name="optin"></span></div>
		...
		<div class="submit clearfix">
			...
			<input type="hidden" value="my-account" name="back" class="hidden">			<button class="btn btn-outline button button-medium" id="submitAccount" name="submitAccount" type="submit">
...
<div class="footer-block block col-xs-12 col-sm-4 col-md-2 col-lg-2">
	<h4 class="title_block">My account</h4>
		<ul class="list-block toggle-footer list-group">
			<li><a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=history" title="My orders" rel="nofollow">My orders</a></li>
						<li><a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=order-slip" title="My credit slips" rel="nofollow">My credit slips</a></li>
			<li><a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=addresses" title="My addresses" rel="nofollow">My addresses</a></li>
			<li><a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=identity" title="Manage my personal information" rel="nofollow">My personal info</a></li>
...
<!-- /Block myaccount module -->
	...
	<div class="footer-block block block_various_links col-lg-2 col-md-2 col-sm-4 col-xs-12">
		...
		<ul class="block_content toggle-footer list-group list">
												<li class="item">
						<a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?id_cms=4&amp;controller=cms&amp;id_lang=1" title="About us">
							About us
						</a>
					</li>
																<li class="item">
						<a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?id_cms=5&amp;controller=cms&amp;id_lang=1" title="Secure payment">
							Secure payment
						</a>
					</li>
																<li class="item">
						<a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?id_cms=6&amp;controller=cms&amp;id_lang=1" title="Typo">
							Typo
						</a>
					</li>
														<li class="item">
					<a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=stores" title="Our stores">
						Our stores
					</a>
				</li>
												
			<li>
				<a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=sitemap" title="Sitemap">
					Sitemap
				</a>
			</li>
				        <li>
                <a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=supplier" title="View a list of suppliers">
                    Suppliers
                </a>
            </li>	
...
<div  class="footer-block block contactinfos col-lg-3 col-md-3 col-sm-3 col-xs-12 hidden-sm">
        ...
        <ul class="list-group list">
                            ...
                            <li>
                    <i class="icon-map-marker"></i>No 1104 Sky Tower,  Newyork, USA
                </li>
                                        <li>
...
<div id="newsletter_block_left" class="block pts-newsletter col-lg-3 col-md-3 col-sm-3 col-xs-12">
	...
	<div class="block_content">
		...
		<form action="<%=request.getContextPath() %>/URegistrationServlet?flag=insert" class="formNewLestter" id="formNewLestter" method="post">
			<div class="content form-group" >
				<div class="wapper">
					<div class="description">
						<span>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat</span>
					</div>
					<div class="input-form">
						...
						<div class="button-submit">
			                <button type="submit" name="submitNewsletter" class="text-theme-color btn btn-outline button button-newsletter">
			                    <span>Subcribe</span>
			                </button>
	                	</div>
					</div>	
...
<!-- /Block Newsletter module-->
                ...
                <div class="box block pts-custom logo-footer" data-href="#">
                    <div class="mask"></div>
                    <a href="#" class="item-link">                                                    <img src="img/logo-footer.png.png" class="item-img img-responsive" alt="" />
                                            </a>  
...
$(document).ready( function(){
	 $('#pts-paneltool').PtsPanelTools({ url:'http://pavodemo.com/prestabrain/bella/cyan/themes/pf_bella/css/profiles/', 'profile': '' } );
});
</script>
				...
				<section id="pts-footer-top" class="footer-top parallax">
					<div class="container">
						<div class="row">
                                                    ...
                                                    <div class="ptsstaticontent_footertop staticontent-item-1 staticontent-item col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <div class="box block pts-custom " data-href="#">
                    <div class="mask"></div>
                    <a href="#" class="item-link" target="_blank">                                                    <img src="img/paypal.png" class="item-img img-responsive" alt="" />
                                            </a>  
						...
						<div class="inner">
							<div class="row">
								<div id="pts-copyright" class="copyright">
									<div class="row">
										<div class="col-xs-12">
																								<div class="copyright"><p>Your Store Copyright Here</p> </div>
				...
				<section id="footer-bottom" class="fixed-footer">
					<div class="container">
						<div class="row">
							
   
                                                
                                                    <div class="ptsstaticontent_footerbottom staticontent-item-1 staticontent-item col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <div class="box block pts-custom " data-href="#">
                    <div class="mask"></div>
                    <a href="#" class="item-link">                                            </a>  

                                        <div class="block_content description" data-href="#">
                                                    <div class="social"><a class="google-plus" title="" href="#" data-toggle="tooltip" data-placement="top" data-original-title="Google-plus"><em class="icon-google-plus">&nbsp; </em> </a> <a class="facebook" title="" href="#" data-toggle="tooltip" data-placement="top" data-original-title="Facebook"> <em class="icon-facebook">&nbsp; </em> </a> <a class="twitter" title="" href="#" data-toggle="tooltip" data-placement="top" data-original-title="Twitter"> <em class="icon-twitter">&nbsp; </em> </a><a class="rss" title="" href="#" data-toggle="tooltip" data-placement="top" data-original-title="Rss"> <em class="icon-rss">&nbsp; </em> </a><a class="pinterest" title="" href="#" data-toggle="tooltip" data-placement="top" data-original-title="Pinterest"> <em class="icon-pinterest">&nbsp; </em> </a></div>                        
                                            </div>
                </div>
            </div> 
	...
	<div class="return-top">
		<i class="icon"></i>
		<span class="hidden-xs hidden-sm">Go on top</span>
	</div>
	<div id="fancybox-compare-add" style="display:none;">
	   <div id="fancybox-html">
		    <div class="msg">Add product to compare successful</div>
			    <a href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=products-comparison" title="compare product">
