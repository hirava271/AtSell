...
<link rel="icon" type="img/vnd.microsoft.icon"
...
<link rel="stylesheet" href="css/blockcurrencies.css" type="text/css"
	media="all" />
<link rel="stylesheet" href="css/blockfacebook.css" type="text/css"
	media="all" />
...
<link rel="stylesheet" href="css/blockuserinfo.css" type="text/css"
	media="all" />
<link rel="stylesheet" href="css/homeslider.css" type="text/css"
	media="all" />
...
<body id="index"
	...
	<header id="header" class="header-v2" style="background: #ffffff">
	<div class="topbar">
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
					<div id="logo-theme" class="logo-store">
						<div class="logo-theme">
							<a 
								title="@Sell"> <img src="<%=request.getContextPath() %>/user/img/logo.png" alt="logo" />
							</a>
						</div>
					</div>
				</div>
										...
										<div class="row">
											...
											<div class="col-xs-4">
												<em class="icon icon-envelope-o">&nbsp;</em><span
													...
													class="text text-theme-color">at_sell@gmail.com</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div id="cart" class="shopping_cart quick-cart clearfix">
									<div class="heading">
										...
										<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
											<a
												href="<%=request.getContextPath() %>/user/add_to_cart.jsp"
												title="View my shopping cart" rel="nofollow">
												<div class="cart-icon"></div> <span
												class="ajax_cart_no_product">${sessionScope.list_size_db }</span> <span
												class="ajax_cart_quantity unvisible">${sessionScope.list_size_db }</span> <span>items</span>
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<div id="logo-theme-keep" class="logo-store">
						<div class="logo-theme">
							<a
								title="Bella store"> <img src="<%=request.getContextPath() %>/user/img/logo.png" />
							</a>
						</div>
					</div>
						...
						<div class="navbar" role="navigation">
							...
							<div id="pts-top-menu"
								...
								<ul class="nav navbar-nav megamenu">
												...
												<div class="row">
													<div class="mega-col col-sm-12" data-type="menu">
														<div class="mega-col-inner">
															<ul>
															<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="v" %>
																<v:forEach items="${sessionScope.menu}" var="i">
																	<v:choose>
																										...
																										<li class=" "><div class="menu-content">
																												<ul>
																													<v:forEach items="${i.value }" var="j">
																														<li><a href="<%=request.getContextPath()%>/UProductSelectionServlet?flag=subcategory_search&id=${j.subcategory_id}&name=${j.subcategory_name}&desc=${j.subcategory_description}">${j.subcategory_name}</a></li>
																													</v:forEach>
																												</ul>
																											</div></li>
																									</ul>
																		...
																		<v:otherwise>
																			<li class=" "><a
																				href="http://pavodemo.com/prestabrain/bella/cyan/index.php?controller=#">
									...
									<li class=""><a
										href="<%=request.getContextPath() %>/user/Ucomplaint.jsp"
										target="_self"><span class="menu-title">Complaint</span></a></li>
									<li class=""><a
										href="<%=request.getContextPath() %>/user/Ufeedback.jsp"
										target="_self"><span class="menu-title">Feedback</span></a></li>
									<li class=""><a
