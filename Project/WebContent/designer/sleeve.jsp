...
<form class="form-horizontal" role="form"  method="post" action="<%=request.getContextPath()%>/DSleeveServlet?flag=insert">
<div class="form-group">
<label class="col-sm-2 control-label" id="sleeve_type">Sleeve Type:</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="sleeve_type">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label" id="sleeve_description">Sleeve Description:</label>
<div class="col-sm-10">
<textarea class="form-control" rows="3" name="sleeve_description"></textarea>
</div>
</div>
