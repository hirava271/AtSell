...
<form class="form-horizontal" role="form" method="post" action="<%=request.getContextPath()%>/DSizeServlet?flag=insert">
...
<div class="col-sm-10">
<textarea class="form-control" rows="3" name="size_description"></textarea>
</div>
</div>
