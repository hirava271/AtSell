...
<c:forEach items="${sessionScope.delivery}" var="i" varStatus="ii">
<c:set var="mst" value="${i[0]}"></c:set>
<c:set var="dtl" value="${i[1]}"></c:set>
 <tr>
 <td>${ii.count}</td>
<td>${dtl.designer_user_id.user_name}</td>
<td>${mst.buyer_user_id.first_name} &nbsp;${mst.buyer_user_id.last_name}</td>
